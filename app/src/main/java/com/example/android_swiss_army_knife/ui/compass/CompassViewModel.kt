...
class CompassViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val compassRotation = MutableLiveData<Double>().apply {
        value = 0.0
    }
    ...
    private fun updateTextWithSensorValues() {
        ...
        val compassRadianMeasurement = mOrientation[0]
        val compassDegreeMeasurement = Math.toDegrees(compassRadianMeasurement.toDouble())
